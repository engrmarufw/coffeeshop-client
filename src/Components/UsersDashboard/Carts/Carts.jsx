...
const Carts = () => {
    const [carts, refetch, loading] = useCarts()
        ...
        <div>
            {
                loading ? <div className="w-full h-screen flex items-center justify-center p-4"><span className="loading loading-dots loading-lg "></span></div> : <>
                    ...
                    <h2 className="text-3xl text-center font-bold my-3">Your Cart Items</h2>
                    <div className="container md:flex justify-between md:p-0 p-4 mb-3">
                        <div className="md:w-3/4 shadow-xl card md:me-4 md:mb-0 mb-4">

                            {
                                carts.length === 0 ? <>

                                    <div className="text-5xl h-screen font-bold opacity-20 flex items-center justify-center">
